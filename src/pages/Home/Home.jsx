...
const Home = () => {
  return (
        <Box className="header-container">
          ...
          <img src={viñedo} alt="Imagen Bodega" className="responsive-img" />
          </Grid>
          <Grid container spacing={3} className="section">
            <Grid item xs={12} md={6}>
              <Typography variant="body1" gutterBottom className="about-text">
          Bienvenidos a la bodega 7 Castrillos, un testimonio viviente de una tradición familiar.<br />
          </Typography>
          ...
          ¿interesado en conocer nuestras instalaciones?
          </Button>
          </Box>
        </Grid>
        <Grid item xs={12} md={6}>
      ...
      <Grid container spacing={3} className="section">
        ...
        Nuestras catas gratuitas son una invitación a sumergirse en este universo de sabores. Cada visita es una oportunidad para aprender, degustar y, por supuesto, encontrar ese vino perfecto que se llevará a casa, no solo como una compra sino como una experiencia inolvidable de la riqueza vinícola de Canarias.
          ...
          <Box className="center-button">
          <Button variant="contained" component={Link} to="/vinos" sx={{ backgroundColor: "#637E51", color: "#FFFFFF", '&:hover': { backgroundColor: "#F8FFFB" }, margin: "10px 0" }}>          
      ...
      <Grid container spacing={3} className="section">
        ...
        ¿interesado en saber sobre nuestras bodegas y quienes somos?, aquí puedes encontrar toda la información que puedas necesitar.
          ...
          <Box className="center-button">
          <Button variant="contained" component={Link} to="/about" sx={{ backgroundColor: "#637E51", color: "#FFFFFF", '&:hover': { backgroundColor: "#F8FFFB" }, margin: "10px 0" }}>          
              ¡Conócenos!
            </Button>
          </Box>
        </Grid>
