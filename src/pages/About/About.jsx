...
const About = () => {
  return (
        <Box className="about-container">
          ...
          Fundada por los hermanos Castrillo, cuya infancia estuvo inmersa entre viñedos y sueños de vendimias, la bodega es un espejo del amor y la dedicación a la tierra.<br /> <br />
          ...
          <Button variant="contained" component={Link} to="/bodegas" sx={{ backgroundColor: "#637E51", color: "#FFFFFF", '&:hover': { backgroundColor: "#F8FFFB" }, margin: "10px 0" }}>          
